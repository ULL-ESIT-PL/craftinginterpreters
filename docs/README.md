...
I followed the [first approach using `brew`](/docs/make-get-old-dart.chatgpt.md#approach-1-installing-an-old-dart-version-with-brew):
...
Then I followed the section "Building" in [README.md](/docs/README.md):
