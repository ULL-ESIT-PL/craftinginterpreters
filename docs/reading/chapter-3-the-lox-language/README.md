...
See also how the comment in the book at [/book/the-lox-language.md]([/book/the-lox-language.md](/book/the-lox-language.md)) is [rendered on the right side](https://craftinginterpreters.com/the-lox-language.html#hello-lox), and the source markdown:
